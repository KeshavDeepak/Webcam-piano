...
function draw() {
    ...
    currImg.resize(1/4 * currImg.width, 1/4 * currImg.height);
    currImg.filter(BLUR, 3);

    diffImg = createImage(video.width, video.height);
    diffImg.loadPixels();

    // resize diffImg to a quarter of its original size
    diffImg.resize(1/4 * diffImg.width, 1/4 * diffImg.height);
    /////////////////////////////////// end of code I wrote ///////////////////////////////////
    ...
    // make prevImg current image so next frame it is valid
